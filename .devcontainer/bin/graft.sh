...
if [ "$FIRST_RUN" -eq 1 ] && [ "$DRY_RUN" != "true" ]; then
  ...
  if [ "$NON_INTERACTIVE" != "true" ] && [ -f "README.md" ]; then
    ...
    if prompt_confirm "Insert Codespaces badge & graft credit into README.md?" yes; then
      ...
      credit_line="Codespace created by [<img src=\".devcontainer/assets/icon.svg\" width=\"16\" height=\"16\" alt=\"cs-grafting\" /> evlist/codespaces-grafting](https://github.com/evlist/codespaces-grafting)"
